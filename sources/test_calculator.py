...
class Test(unittest.TestCase):
    ...
    def test_add_float(self):
        ...
        """
        self.assertIsNone(calculator.add("2.2", "4.5"))

    def test_sous(self):
        """
        La soustraction de 144 par 12 doit retourner 132.
        """
        self.assertEqual(calculator.sous("144", "12"), 132)

    def test_sous_str(self):
        """
        La soustraction de 31 par - ne doit rien retourner.
        """
        self.assertIsNone(calculator.sous("31", "-"))
